...
return [
    ...
    */
    ...
    'connections' => [
        ...
        Auditor::CONNECTION => [
            'driver'         => 'mysql',
            'url'            => env('EP_AUDIT_DATABASE_URL', env('DATABASE_URL')),
            'host'           => env('EP_AUDIT_DB_HOST', env('DB_HOST', '127.0.0.1')),
            'port'           => env('EP_AUDIT_DB_PORT', env('DB_PORT', '3306')),
            'database'       => env('EP_AUDIT_DB_DATABASE', env('DB_DATABASE', 'forge')),
            'username'       => env('EP_AUDIT_DB_USERNAME', env('DB_USERNAME', 'forge')),
            'password'       => env('EP_AUDIT_DB_PASSWORD', env('DB_PASSWORD', '')),
            'unix_socket'    => env('EP_AUDIT_DB_SOCKET', env('DB_SOCKET', '')),
            'charset'        => 'utf8mb4',
            'collation'      => 'utf8mb4_0900_as_ci',
            'timezone'       => '+00:00',
            'prefix'         => '',
