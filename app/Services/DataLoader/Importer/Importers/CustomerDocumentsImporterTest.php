...
/**
 * @internal
 * @coversDefaultClass \App\Services\DataLoader\Importer\Importers\CustomerDocumentsImporter
 */
class CustomerDocumentsImporterTest extends TestCase {
    use WithQueryLogs;
    use Helper;
    ...
    public function testImport(): void {
        ...
        $this->app->make(CustomerDocumentsImporter::class)
            ->setUpdate(true)
            ->setCustomerId(CustomerDocumentsImporterData::CUSTOMER)
