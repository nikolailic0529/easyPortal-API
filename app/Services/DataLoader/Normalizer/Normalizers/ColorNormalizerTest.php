...
/**
 * @internal
 * @coversDefaultClass \App\Services\DataLoader\Normalizer\Normalizers\ColorNormalizer
 */
class ColorNormalizerTest extends TestCase {
    ...
    public function testNormalize(mixed $expected, mixed $value): void {
        $this->assertEquals($expected, $this->app->make(ColorNormalizer::class)->normalize($value));
    }
    // </editor-fold>
