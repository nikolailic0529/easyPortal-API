...
/**
 * @internal
 * @coversDefaultClass \App\GraphQL\Queries\Contracts\ContractEntryFields
 *
 * @phpstan-import-type OrganizationFactory from WithOrganization
 * @phpstan-import-type UserFactory from WithUser
 * @phpstan-import-type TranslationsFactory from WithTranslations
 */
class ContractEntryFieldsTest extends TestCase {
    ...
    public function testInvoke(
        ...
        $this
            ->graphQL(/** @lang GraphQL */ '{
                contractEntryFields(where: { contracts: { where: {}, count: {lessThan: 1} }}) {
                    id
                    name
                }
            }')
    ...
    public function dataProviderInvoke(): array {
        $provider = new ArrayDataProvider([
            'ok' => [
                new GraphQLSuccess('contractEntryFields', [
                    [
        ...
        return (new MergeDataProvider([
            'contracts-view' => new CompositeDataProvider(
                new AuthOrgDataProvider('contractEntryFields'),
                new OrgUserDataProvider('contractEntryFields', [
                    'contracts-view',
                ]),
                $provider,
            ),
