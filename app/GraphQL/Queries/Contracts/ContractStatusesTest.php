...
/**
 * @internal
 * @covers \App\GraphQL\Queries\Contracts\ContractStatuses
 *
...
class ContractStatusesTest extends TestCase {
    ...
    public function dataProviderInvoke(): array {
        $provider = new ArrayDataProvider([
            'ok' => [
                new GraphQLSuccess('contractStatuses', [
                    [
        ...
        return (new MergeDataProvider([
            'contracts-view' => new CompositeDataProvider(
                new AuthOrgDataProvider('contractStatuses'),
                new OrgUserDataProvider('contractStatuses', [
                    'contracts-view',
                ]),
                $provider,
            ),
