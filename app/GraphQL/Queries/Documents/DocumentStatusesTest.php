...
/**
 * @internal
 * @coversDefaultClass \App\GraphQL\Queries\Documents\DocumentStatuses
 */
class DocumentStatusesTest extends TestCase {
    ...
    public function testInvoke(
        ...
        $this
            ->graphQL(/** @lang GraphQL */ '{
                documentStatuses(where: { documents: { where: {}, count: {lessThan: 1} }}) {
                    id
                    name
                }
            }')
    ...
    public function dataProviderInvoke(): array {
        $provider = new ArrayDataProvider([
            'ok' => [
                new GraphQLSuccess('documentStatuses', DocumentStatuses::class, [
                    [
        ...
        return (new MergeDataProvider([
            'customers-view' => new CompositeDataProvider(
                new OrganizationDataProvider('documentStatuses'),
                new OrganizationUserDataProvider('documentStatuses', [
                    'customers-view',
                ]),
                $provider,
            ),
