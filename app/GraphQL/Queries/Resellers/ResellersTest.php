 ...
 * @phpstan-type        ResellerFactory \Closure(static, ?Organization, ?\App\Models\User): Reseller|null
 */
    ...
    public function dataProviderQuery(): array {
        return (new MergeDataProvider([
            'root' => new CompositeDataProvider(
                new AuthOrgRootDataProvider('resellers'),
                new OrgUserDataProvider('resellers'),
