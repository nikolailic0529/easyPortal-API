...
CREATE TABLE IF NOT EXISTS `logs` (
    ...
    `emergency_count`      MEDIUMINT(8) UNSIGNED                NOT NULL DEFAULT 0,
    `alert_count`          MEDIUMINT(8) UNSIGNED                NOT NULL DEFAULT 0,
    `critical_count`       MEDIUMINT(8) UNSIGNED                NOT NULL DEFAULT 0,
    `error_count`          MEDIUMINT(8) UNSIGNED                NOT NULL DEFAULT 0,
    `warning_count`        MEDIUMINT(8) UNSIGNED                NOT NULL DEFAULT 0,
    `notice_count`         MEDIUMINT(8) UNSIGNED                NOT NULL DEFAULT 0,
    `info_count`           MEDIUMINT(8) UNSIGNED                NOT NULL DEFAULT 0,
    `debug_count`          MEDIUMINT(8) UNSIGNED                NOT NULL DEFAULT 0,
