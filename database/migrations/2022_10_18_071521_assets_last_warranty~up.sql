...
ALTER TABLE `assets`
    ADD COLUMN `warranty_id`               CHAR(36) NULL DEFAULT NULL AFTER `nickname`,
    ...
    ADD INDEX `fk_assets_asset_warranties1_idx`(`warranty_id` ASC) VISIBLE,
...
ALTER TABLE `assets`
    ADD CONSTRAINT `fk_assets_asset_warranties1`
